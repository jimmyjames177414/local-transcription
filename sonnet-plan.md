 ...
 Utility: TranscriptEventJsonParser.TryParse
 Location: src/LocalTranscriber.Agent/TranscriptEventTailer.cs                                        Usage: Parse .jsonl lines for transcript context                                              ────────────────────────────────────────                                                            Utility: SafePathValidator.ResolveInsideRoot
 Location: src/LocalTranscriber.Shared/
 Usage: Validate workspace path before use
 ────────────────────────────────────────                                                         Utility: PersistConfig helper
 Location: AgentPanelViewModel
 Usage: Persist new config properties                                                                ────────────────────────────────────────
 Utility: IRealtimeVoiceConversation
 Location: src/LocalTranscriber.Voice/RealtimeVoiceOptions.cs
 Usage: Interface to implement
 ...
 5. Type "What project is this?" in the chat input — response should reference GymSpots or calTranscriber depending on which workspace was set
 ...
 Test with invalid workspace path — should show error state, not crash